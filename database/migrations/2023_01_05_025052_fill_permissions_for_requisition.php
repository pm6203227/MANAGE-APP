...
class FillPermissionsForRequisition extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRequisition constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.requisition',
            'admin.requisition.index',
            'admin.requisition.create',
            'admin.requisition.show',
            'admin.requisition.edit',
            'admin.requisition.delete',
            'admin.requisition.bulk-delete',
        ]);
